////////////////////////////////////////////////////////////////////
//DeRap: A3CN_Scopes\config.bin
//Produced from mikero's Dos Tools Dll version 6.44
//'now' is Sat Aug 10 22:57:54 2019 : 'file' last modified on Sun Sep 03 02:05:56 2017
...
class CfgPatches
{
	...
	{
		units[] = {};
		weapons[] = {"optic_LRPS_Themal","a3cn_LSMARK4","a3cn_LSMARK4_Delta","a3cn_LSMARK4_Thermal","a3cn_LSMARK4_Sand","a3cn_sb31250","a3cn_ANPVS10","a3cn_ANPVS10_Green","a3cn_anpasl","a3cn_anpasm","a3cn_ANPVS4"};
		requiredversion = 0.1;
		requiredaddons[] = {"A3_Weapons_F_Acc","asdg_jointrails"};
	};
};
...
class CfgWeapons
{
	...
	class a3cn_LSMARK4: optic_LRPS
	{
		...
		picture = "x\a3cn_scopes\addons\main\ui\riflescope.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_01.p3d";
	...
	class a3cn_LSMARK4_Delta: a3cn_LSMARK4
	{
		...
		picture = "x\a3cn_scopes\addons\main\ui\m3delta.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_07.p3d";
	...
	class a3cn_LSMARK4_Sand: a3cn_LSMARK4
	{
		...
		picture = "x\a3cn_scopes\addons\main\ui\riflescope.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_09.p3d";
	...
	class a3cn_SB31250: optic_LRPS
	{
		...
		picture = "x\a3cn_scopes\addons\main\ui\sb31250.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_02.p3d";
	...
	class a3cn_ANPVS10: optic_Nightstalker
	{
		...
		picture = "x\a3cn_scopes\addons\main\UI\anpvs10black.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_03.p3d";
	...
	class a3cn_ANPVS10_Green: a3cn_ANPVS10
	{
		...
		picture = "x\a3cn_scopes\addons\main\UI\anpvs10green.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_03_green.p3d";
	};
	class a3cn_ANPASM: optic_tws
	{
		...
		picture = "x\a3cn_scopes\addons\main\UI\anpas13m.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_04.p3d";
	...
	class a3cn_ANPASL: optic_tws
	{
		...
		picture = "x\a3cn_scopes\addons\main\UI\anpas13l.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_05.p3d";
	...
	class a3cn_ANPVS4: optic_Nightstalker
	{
		...
		picture = "x\a3cn_scopes\addons\main\UI\anpvs4.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_06.p3d";
	...
	class a3cn_M68CCO: ItemCore
	{
		...
		author = "Hippye";
		displayName = "M68 CCO";
		picture = "x\a3cn_scopes\addons\main\UI\aimpoint.paa";
		model = "x\a3cn_scopes\addons\main\data\models\scope_08.p3d";
